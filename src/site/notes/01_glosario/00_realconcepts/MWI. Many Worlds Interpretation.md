...
La interpretación de los muchos mundos implica que lo más probable es que existan infinitos universos​ y es una de las muchas hipótesis de multiversos en física y filosofía. La IMM ve el tiempo como un árbol con muchas ramas, en el que se realizan todos los resultados cuánticos posibles. Con ello se pretende resolver el problema de la medida y por tanto, algunas paradojas de la teoría cuántica, como la del amigo de Wigner, la paradoja EPR y el gato de Schrödinger, ya que cada posible resultado de un suceso cuántico existe en su propio universo.
